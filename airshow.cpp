...
void front()
{
        ...
        output(365,130,"",fonts[3]);
        glColor3f(0.3,0.5,0.8);
        output(375,100,"DEPT. OF COMPUTER SCIENCE & ENGG.",fonts[0]);
        glColor3f(0.8,0.1,0.2);
        output(300,600,"GRAPHICAL IMPLEMENTATION OF AIRSHOW",fonts[2]);
        glColor3f(1.0,0.0,1.0);
        output(450,500,"",fonts[0]);
        glColor3f(0.3,0.5,0.8);
        output(225,450,"",fonts[3]);
        output(670,450,"",fonts[3]);
        output(180,300,"",fonts[3]);
        output(220,400,"",fonts[0]);
        output(680,400,"",fonts[0]);
...
void help()
{
     ...
     output(180,560,"=> RIGHT CLICK MOUSE TO STOP THE ROTATIONAL TRANSLATION <=",fonts[3]);
        ...
        glColor3f(0.5,0.2,0.6);
        output(600,60,"[ Dept. of CS&E]",fonts[0]);
}
void intro()
{
        glColor3f(0.8,0.1,0.2);
        output(170,480,"GRAPHICAL IMPLEMENTATION OF AIRSHOW",fonts[2]);
        glColor3f(0.0,0.6,0.3);
        output(160,430,"IN THIS AIRSHOW A GROUP OF AIRPLANE EMITSCOLORFUL SMOKE",fonts[0]);

        output(160,400,"    WHICH PAINTS THE SKY IN TRICOLOR(INDIANFLAG).",fonts[0]);
        glColor3f(0.3,0.5,0.8);
